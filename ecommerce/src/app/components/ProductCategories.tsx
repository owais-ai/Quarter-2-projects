...
const ProductCategories = () => {
  return (
    <div className="py-4 px-4">
      ...
      <div className="flex items-center mb-10 mx-auto">
          <div className="w-5 h-10 rounded-md bg-[#DB4444] font-semibold flex items-center">
          </div>
          <span className="ml-3 text-[#DB4444] font-semibold">Categories</span> 
        </div>
      ...
      <div className="flex justify-center md:justify-between flex-wrap mb-6 gap-4">
